...
function SpeakerCard({name , picture , Designation , Company , Linkedin}) {
  return (
    <div className='w-1/5 h-1/4 flex justify-center items-center flex-col bg-white lg:m-[6vmax] sm:mx-[20vmax]  sm:my-[3vmax] px-0 pt-[0.5vmax] pb-[1vmax] ticket'>
        ...
        <button onClick={(e)=>{e.preventDefault() ; window.open( Linkedin , '_blank')}} class="bg-[#542436] p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-lg">
