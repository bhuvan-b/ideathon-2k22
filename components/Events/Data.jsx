const Data = [
  {
    ...
    cashPrize: "6,500",
    eventDescription:
      "“Knowledge is of no value unless you put it into practice”. Here’s a fun and educative excursion to test your knowledge of entrepreneurship, one of the most quickly developing global topics! A successful entrepreneur needs both knowledge and business sense, but the knowledge aspect is usually ignored. Don’t worry because we are about to facet this side of knowledge. ",
    para2:
  ...
  {
    name: "pitch2win",
    eventIcon: "https://i.imgur.com/8L1LNLE.png",
    eventName: "Pitch2Win",
    teamSize: "1-2",
    cashPrize: "5,000",
    eventDescription:
      "The entrepreneur in you has come up with a breakthrough idea. After building a product, you need investors. This is where your elevator pitch needs to be perfect. The current scenario is filled with a new start-up idea almost everyday. Your pitching skills will be of paramount importance now more than ever. ",
    para2:
  ...
  {
    name: "toptalks",
    eventIcon: "https://i.imgur.com/qN5rh6d.png",
    eventName: "TopTalks",
    teamSize: "Individual",
    cashPrize: "5,000",
    eventDescription:
      "Elon Musk wants a hostile takeover of Twitter. The board members and shareholders are in a frenzy.  Amidst this crisis, you, one of the board of directors, must come to the most optimal solution. Your ability to do that peacefully in the thick of desperation is essentially what Top Talks is all about. ",
    para2:
